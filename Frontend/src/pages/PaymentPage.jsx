                ...
                <div className="font-sans md:max-w-4xl max-md:max-w-xl mx-auto mt-12">
                    <div className="grid md:grid-cols-3 gap-4">
                                    ...
                                    <div className="col-span-2 flex items-center gap-4">
                                        ...
                                        <div className="w-96">
                                            ...
                                            <div className="flex gap-4 mt-4">
                                                ...
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 124 124" onClick={minusProduct}>
                                                        <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" />
                                                    </svg>
                                                    <span className="mx-2.5">{count}</span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 42 42" onClick={plusProduct}>
                        ...
                        <div className="bg-white border rounded-md p-4 md:sticky top-0">
                            ...
                            <div className="mt-10 space-y-2" onClick={handlePriceChange}>
                                <PayPromptPay
