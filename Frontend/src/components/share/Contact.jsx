        ...
        <div className="py-8 lg:py-16 px-4 max-w-screen-md">
            ...
            <form action="#" className="space-y-8">
                ...
                <div className="flex items-center justify-center">
                    <button type="button" className="mt-10 text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 ">Send message</button>
                </div>
            </form>
        </div>
    )
